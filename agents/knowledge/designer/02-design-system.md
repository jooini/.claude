...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-designer/design-system

---

## 1. 디자인 시스템이란?

재사용 가능한 컴포넌트와 명확한 표준의 집합으로, 규모 있는 제품을 일관성 있게 관리하기 위한 **단일 진실 공급원(Single Source of Truth)**.
