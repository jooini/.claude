...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-po/case-studies
...
**배경:** Tiny Speck(게임 회사)의 내부 커뮤니케이션 도구 → 제품화

**핵심 의사결정:**
1. **Pivot**: 게임(Glitch) 실패 → 내부 도구를 제품화
2. **포지셔닝**: "이메일 킬러"가 아닌 "팀 커뮤니케이션"
3. **PLG**: 팀 초대 기반 바이럴 → 높은 K-factor
4. **Freemium**: 10K 메시지 제한 → 가치 경험 후 자연스러운 전환

**PMF 신호:** 출시 24시간 내 8,000팀 가입. 사용자가 "이메일로 돌아갈 수 없다"고 언급. 팀 단위 유기적 확산.
