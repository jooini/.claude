...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-po/analytics
...
**2. Path Analysis**
사용자가 실제로 어떤 경로로 이동하는지 시각화 → 의도한 경로 vs 실제 경로의 차이 발견

**3. Cohort Analysis**
같은 시점에 가입한 사용자 그룹의 시간에 따른 행동 추적 → 제품 변화의 영향 측정

**4. Power User Analysis**
가장 활발한 상위 10% 사용자의 행동 패턴 분석 → 이상적인 사용 패턴 발견 → 다른 사용자를 이 패턴으로 유도
