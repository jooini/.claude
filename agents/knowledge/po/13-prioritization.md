...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-po/prioritization
...
```
Feature A: 온보딩 체크리스트
  Reach: 5,000 / Impact: 2 / Confidence: 80% / Effort: 2
  RICE = (5000 × 2 × 0.8) / 2 = 4,000

Feature B: 다크 모드
  Reach: 15,000 / Impact: 0.5 / Confidence: 90% / Effort: 3
  RICE = (15000 × 0.5 × 0.9) / 3 = 2,250

Feature C: 실시간 알림
  Reach: 8,000 / Impact: 1 / Confidence: 50% / Effort: 4
...
Dan Olsen의 프레임워크. Importance(중요도) vs Satisfaction(만족도) 분석.
...
현재 North Star인 activation rate에 영향을 주는
온보딩 개선이 90%의 사용자에게 도움이 됩니다."
```
