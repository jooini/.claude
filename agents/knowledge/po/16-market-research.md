...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-po/market-research
...
│    │   ┌──────────┐    │        │
│    │   │   SOM    │    │        │  Serviceable Obtainable Market (실제 획득 가능)
│    │   └──────────┘    │        │
│    └───────────────────┘        │
└─────────────────────────────────┘
```

- **TAM** — 모든 잠재 고객이 사용할 경우의 시장. 계산: Top-down(리포트 기반) / Bottom-up(고객수 × ARPU) / Value theory
- **SAM** — 지역·세그먼트·채널로 필터링한 현실적 시장. TAM에서 실제 도달 가능한 부분
- **SOM** — 단기(1-3년)에 실제 확보 가능한 시장. 보통 SAM의 1-5% (초기 스타트업)

**실전 예시:**
```
제품: B2B SaaS 프로젝트 관리 도구

TAM: 글로벌 PM SW 시장 = $7.5B (2025)
SAM: 아시아-태평양 10-500인 기업 = $1.2B
SOM: 한국 스타트업 (50-200인) = $45M/년
...
```
Signal → Pattern → Meaning → Opportunity
