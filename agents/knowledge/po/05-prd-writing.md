...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-po/prd-writing

---

## PRD란?

PRD(Product Requirements Document)는 **왜 만드는지, 누구를 위한 것인지, 무엇을 만드는지, 성공을 어떻게 측정하는지**를 정리한 문서다. 개발팀이 "무엇을 만들어야 하는지" 명확히 알 수 있어야 한다.
...
9. **Timeline & Milestones** — 마일스톤별 날짜
10. **Open Questions** — 미결 사항 명시
11. **Appendix** — 참고 자료
