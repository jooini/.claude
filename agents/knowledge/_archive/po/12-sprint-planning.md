...
> 원본: https://ironact.gitbook.io/ironact-docs/CrEhRPJQJpia3xh9iqbi/knowledge-po/sprint-planning

---

## Sprint Goal 설정

이번 Sprint에서 달성하려는 **하나의 명확한 목표**. 개별 아이템 나열이 아닌, 합쳐서 만드는 결과.

**좋은 Sprint Goal 조건:** 한 문장 / 측정 가능 / 분기 Outcome 연결 / 팀 전원 이해·동의

예시:
- ❌ "대시보드 작업, 알림 기능, 버그 수정"
- ✅ "팀 리더가 프로젝트 상태를 실시간으로 파악할 수 있는 MVP 대시보드 출시"
