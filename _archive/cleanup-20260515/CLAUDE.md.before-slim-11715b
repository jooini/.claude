...
- 🔴/🟡 도메인에서 추정으로 답한 게 틀렸으면 즉시 사과 + 검증 + 정정. **같은 추정 두 번 금지**
- 🟢 도메인에서도 검증 못 한 부분은 "추정" 명시 또는 "검증 필요" 표시
...
| speakingmax-study-insight | `~/Workspace/speakingmax-study-insight` | monorepo (pnpm) · apps/api(Python+FastAPI) + apps/web(Next.js) |
